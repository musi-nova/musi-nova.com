        ...
        <Card className="bg-white rounded-lg shadow-md hover:shadow-lg transition-all">
          <CardContent className="p-6">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2 text-musinova-darkgray">Grow your audience</h3>
                <p className="text-gray-600">
                  Gain new listeners and grow in the Spotify algorithm with our meta ad campaigns.
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="p-6">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  We adjust and refine your ads to ensure the best results for your campaign.
                </p>
              </div>
            </div>
          </CardContent>
